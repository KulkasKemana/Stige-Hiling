      ...
      <div class="w-full max-w-md">
        ...
        <form method="POST" action="{{ route('login') }}" class="w-full space-y-4">
          ...
          <input type="email" name="email" placeholder="Email"
                 class="w-full border border-black rounded-lg px-5 py-3 text-base placeholder-black focus:outline-none" required />
          <div class="relative">
            <input type="password" name="password" placeholder="Password"
                   class="w-full border border-black rounded-lg px-5 py-3 text-base placeholder-black focus:outline-none" required />
            <a href="/forgot-password" class="absolute right-3 top-1/2 -translate-y-1/2 text-sm text-blue-600 hover:underline">
              Forget Password?
            </a>
          </div>
          ...
          <button type="submit"
                  class="w-full bg-[#ff914d] text-white font-semibold rounded-lg py-3 text-lg hover:bg-[#ff7a1a] transition">
            Sign In
          </button>
        </form>
