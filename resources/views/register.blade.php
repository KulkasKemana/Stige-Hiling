  ...
  setTimeout(() => {
   ...
   <section class="md:w-1/2 w-full p-10 md:p-14 flex flex-col justify-center">
    ...
    <h1 class="text-2xl font-extrabold mb-2 leading-tight">
     CREATE YOUR ACCOUNT<br/>WITH HEALING TOUR AND TRAVEL
    </h1>
    <p class="text-sm mb-8">
     Please enter your sign up details below
    </p>
    <form class="w-full space-y-6">
     <input class="w-full border border-black rounded-lg px-5 py-3 text-base placeholder-black focus:outline-none" placeholder="Name" required type="text"/>
    ...
    <p class="text-center mt-6 text-sm">
     ...
     <a class="text-blue-600 hover:underline" href="#">Sign In</a>
    </p>
   </section>
  </main>
 </body>
